...
PROJECT = {"analysis_type": "greek", "category": "Derivatives Pricing & Volatility", "columns": ["scenario_id", "spot", "strike", "rate", "volatility", "maturity", "option_type", "position_contracts", "contract_multiplier", "shock_spot_pct", "shock_vol_abs"], "methods": ["Black-Scholes Greek을 계산한 뒤 작은 충격에 대한 2차 근사 손익을 만든다.", "Delta는 방향성, Gamma는 곡률, Vega는 변동성 충격의 영향으로 분리한다.", "수치는 포지션 규모와 충격 손익 연결을 보여주는 학습용 합성 포지션이다."], "module_name": "greek_risk_baseline", "objective": "옵션 포지션의 Delta, Gamma, Vega 노출을 충격 시나리오 손익으로 연결한다.", "question": "기초자산과 변동성이 동시에 움직이면 보유 옵션 포지션 손익은 어떤 Greek에 가장 민감한가?", "rows": [["CALL_DELTA_BOOK", 100, 100, 0.03, 0.22, 0.75, "call", 35, 100, 0.015, 0.02], ["PUT_PROTECTION", 92, 96, 0.028, 0.25, 1.0, "put", 20, 100, -0.02, 0.015], ["VEGA_EVENT", 108, 110, 0.031, 0.31, 0.5, "call", 15, 100, -0.01, 0.04]], "sample_name": "option_position_scenarios.csv", "title_en": "Greek Risk Analysis", "title_ko": "Greek 리스크 분석"}
